...
| 2026-09-06 | `2026-09-06-manifest-pdf-report` | сдан | Итоговый PDF-отчёт по манифесту «Grand Total»: сводная таблица по типам контейнеров и общий вес, с ручным вводом позывного, даты прибытия и терминала выгрузки (в манифесте их нет) |
