...
|---|---|---|---|
| 2026-09-06 | `2026-09-06-manifest-tools` | сдан | Сайт с двумя инструментами: объединение манифестов и сверка опасных грузов с DG-манифестом; публикация на GitHub Pages — по согласованию с пользователем |
